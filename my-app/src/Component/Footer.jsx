import { SimpleGrid,Box,Text, Button,H6,P,HStack, Spacer ,Wrap,WrapItem,Stack, Heading} from '@chakra-ui/react'
import { IconButton,EmailIcon ,ArrowForwardIcon} from '@chakra-ui/react'
...
<SimpleGrid  fontSize={"13px"} row={{base:1,sm:1,md:2,lg:2,'xl':4}} columns={{base:1,sm:1,md:2,lg:4,'xl':4}} spacing={{base:1,sm:1,md:2,lg:2,'xl':2}} >
  ...
  <Stack direction='column' spacing={4} borderTop="1px solid black">
    <HStack>
          <Heading mt="3px" size="xm">About SkinStore </Heading>   
   </HStack>
   <HStack>
   <Text>About Us </Text> 
   </HStack>
